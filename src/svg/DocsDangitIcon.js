export default function DocsDangitIcon(props) {
    return (
        <svg width="254" height="254" viewBox="0 0 254 254" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            <path d="M100.357 64.2495C103.256 61.2911 103.208 56.5426 100.249 53.6434C97.2911 50.7442 92.5426 50.7922 89.6434 53.7505L100.357 64.2495ZM89.6434 53.7505L40.6434 103.751L51.3566 114.249L100.357 64.2495L89.6434 53.7505Z" fill="black"/>
        </svg>
    )
}